...
class User extends \ICGM2\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'last_name', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'admin', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'departement', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'gps_tracking', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'phone', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'mphone', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'zip_code', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'country', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'city', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'company_name', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'position', '' . "\0" . 'ICGM2\\UserBundle\\Entity\\User' . "\0" . 'profile_picture', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
